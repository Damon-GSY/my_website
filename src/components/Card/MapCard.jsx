...
const MapCard = () => {
  const cities = [
    { x: 5, y: 67, icon: '🏖️', name: 'Beach city', anim: '' },
    { x: 32, y: 32, icon: '🌷', name: 'Flower city', anim: 'anim-grow' },
    { x: 58, y: 83, icon: '🏄', name: 'Surf city', anim: 'anim-slidein' },
    { x: 65, y: 22, icon: '🏛️', name: 'Capital city', anim: '' },
    { x: 87, y: 58, icon: '🎢', name: 'Funland', anim: '' },
    { x: 94, y: 38, icon: '🌊', name: 'Coast city', anim: 'anim-slidein' },
  ];
          ...
          {cities.map((city, index) => (
            ...
            >
              <div className="map-city__label">
                <span data-icon={city.icon} className={`map-city__sign anim ${city.anim}`}>
                  {city.name}
                </span>
              </div>
            </div>
