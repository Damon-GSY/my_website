...
requirePattern(scene, /failIfMajorPerformanceCaveat: !softwareRenderer[\s\S]*powerPreference: 'high-performance'/, 'The production scene does not reject a major GPU performance caveat while allowing an explicit software-rendering audit mode.')
